"""
Loads PPCon baseline checkpoints (vendored, unmodified, in ppcon_baseline/)
...
Forward-pass concatenation order matches ppcon_baseline/ppcon/train/train.py's
...
def ppcon_forward(models, year, day, lat, lon, temp, psal, doxy):
    ...
    batch_size=1 callers, same as RawCNNProbe/RawTransformerProbe's (B, D, 1)."""
